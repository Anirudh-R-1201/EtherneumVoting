...
contract Election {
    ...
    function register_candidate(string memory id) public only_election_authority{
        candidates.push(id);
    }
    ...
    function vote(string memory id) public only_registered_voters
        vote_only_once
    ...
    function get_candidate(uint i) public view returns(string memory _candidate, uint _votes){
